...
@Slf4j
@Service(QualirfierConfig.SERVICE.NAVER_V0)
public class NaverServiceImpl implements NaverService{
	
	protected String cat = "BOOK";

	/*
	 * cat와 search 에 담긴 값을 전달받아서 Naver 에 요청할 QueryString 을 생성하는 method
	 */

...
<link rel="stylesheet"
	href="${rootPath}/static/css/modal.css?ver=2022-05-31-00">
<link rel="stylesheet"
...
<script src="${rootPath}/static/js/input.js?ver=2022-05-30-008"></script>
<head />
<body>
	<header> 
	<h1>My Api</h1>
	...
	<nav>
		<ul>
			...
			<%// 로그인을 하였을때 는 member 객체에 로그인한 사용자 정보가 담겨 있다 %>

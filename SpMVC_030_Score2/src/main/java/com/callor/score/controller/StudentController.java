...
public class StudentController {
	...
	public String detail(String st_num, Model model) {
		StudentVO stDetail = stService.findById(st_num);
		model.addAttribute("STUDENT",stDetail);
	
		return "student/detail";
	}
	
	@RequestMapping(value = "/update", method = RequestMethod.GET)
	public String update(String st, Model model) {

		StudentVO addr = stService.update();

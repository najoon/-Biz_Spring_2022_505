...
@Slf4j
@Service(QualifyConfig.SREVICE.MAIL_V2)
public class SandMailServiceImplV2 extends SandMailServiceImplV1 {
	...
	public SandMailServiceImplV2(JavaMailSender sender, ResourceLoader loader) {

...
public class MemoServiceImplV1 implements MemoService {
	...
	public int insertAndUpdate(MemoDTO memo, MultipartFile file) {
		// insert(새로 추가) 가 되는 경우는 m_seq 가 0일 것이고
		// update 가 되는 경우는 ,m_seq가 0이 아닐것이다
	...
	/*
	 * 메모를 삭제할때 1. 첨파일이 있을 경우 파일을 먼저 삭제 해야 한다 2. 데이터를 삭제 한다.
	 * 
	 * 만약 순서가 바뀌게 되면, 필요없는 파일들이 폴더에 남아있을수 있다.
	 */
	@Override

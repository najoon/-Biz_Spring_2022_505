...
public class EmsVO {
	...
	@Length(min = 1, max= 100, message = "받는사람 이름은 1글자 ~100 글자까지만 가능")
	@NotEmpty(message = "받는사람 이름은 반드시 입력하세요")
	private String e_to_name;
	
	@NotEmpty(message = "제목을 반드시 입력")
	private String e_subject;
	private String e_content;
	
	
	//@Size(min = 1 , max = 10, message = "num 는 1부터 10 사이의 값이어야 합니다")
	...
	//@DecimalMax(value="10", message ="declmal 은 십진수 10 보다 작아야합니다")
	private int declmal;
